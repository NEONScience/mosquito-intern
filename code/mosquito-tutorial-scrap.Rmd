...
In this tutorial we want to explore the
abundance of *Culex tarsalis*, but in the identification data table we are only
given the individual count of mosquito species found in each subsample.
...
Preciplag('ABBY', '2012-01-20')

TwoWeekAvgMaxPrecip<-mapply(Preciplag, tiny.df$siteID, tiny.df$Date)
tiny.df <-cbind(tiny.df, TwoWeekAvgMaxPrecip)
```
