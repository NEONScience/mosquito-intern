---
layout: post
title: "Latitudinal Gradients in Mosquito Species Richness: Contributing Factors and Changes Over Time"
date:  2017-06-16
authors: [Charlotte Roiger]
dateCreated: 2017-06-16
lastModified: `r format(Sys.time(), "%Y-%m-%d")`
description: "FILL IN WITH A ONE LINE DESCRIPTION OF TUTORIAL"
image:
...
{% include _toc.html %}
 ...
 In order to address research questions about mosquito populations in the United States, we need the requisite skills and access to data to carry out analysis. This tutorial will focus on obtaining data from the NEON data portal and the Global Historical Climatology Network, provide methods for composing data frames with relevant information, and a preliminary exploration of various research questions related to mosquito data.

**R Skill Level:** Introductory - you've got the basics of `R` down and 
...
*	Download mosquito trapping, identification, and sorting information from the NEON data portal
* Download precipitation and temperature data from Global Historical Climatology Network
* Merge data frames to create one unified data frame with relevant variables to address research questions
* Subset data by year
...
your computer to complete this tutorial. Also, some previous R experience
...
The mosquito data on the NEON Data Portal are divided by type of information into six tables:
