...
specrich <- ddply(idsmall, ~ uniquePlotIDs + domainid + siteid + date + Year + HoursOfTrapping + Precipmm + Max.TempC, summarize, num_species = length(unique(scientificName)))
...
SPTWAMT.mat <- readRDS('SpeciesRichTempLag.rds')
...
CTTWAMT.mat <- readRDS('CulexTarsalisTempLag.rds')
