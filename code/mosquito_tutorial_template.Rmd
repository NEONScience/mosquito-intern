...
str(trap) #View the first five lines of data to get a feel for the structure
```
...
The identification table contains information about all mosquitos that were found
in each subsample. Each sample in the identification dataset contains the target
taxa and once identified is either directly archived, or first sent to an external
lab for Pathogen testing. 
...
return a list of unique plot IDs paired with its corresponding GPS information.
