...
#Create df for domain ID and native code NEED HELP OPTIMIZING THIS UGLY UGLY CODE
tarstax <- unlist(c(taxonomy.df[grepl("Culex tarsalis", taxonomy.df$scientificName), grepl("NativeStatusCode", colnames(taxonomy.df))])[c(5:15,17:23)])
